// This variable keeps track of who's turn its.
let activePlayer = 'X';
...
function audio(audioURL) {
    // We create a new auto object and we pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        // This line indicate where the start of a lines y axis is.
        y1 = coordY1,
        // This line indicate where the end of a lines x axis is.
        x2 = coordX2,
        // This line indicate where the end of a lines y axis is.
        y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            // This condition adds to to the previous end x point.
            if (x < x2) {x += 10}
            // This condition adds to to the previous end y point.
            if (y < y2) {y += 10}
